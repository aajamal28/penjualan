                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-2">Supplier</dt>
                            <dt class="col-sm-10"><?= $trans['name'] ?></dd>
                            <dd class="col-sm-2"></dt>
                            <dt class="col-sm-10"><?= $trans['address'] ?></dd>
                            <dd class="col-sm-2"></dt>
                            <dt class="col-sm-10"><?= $trans['telp'] ?></dd>
                            <dd class="col-sm-2">Nomor Dokumen</dt>
                            <dt class="col-sm-10"><?= $trans['tr_doc'] ?></dd>
                            <dd class="col-sm-2">Tanggal</dt>
                            <dt class="col-sm-10"><?= $trans['tr_docdate'] ?></dd>
