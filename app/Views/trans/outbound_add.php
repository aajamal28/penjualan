...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Transaksi Penjualan</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="trdstock" class="col-sm-1 col-form-label text-navy text-right">Stock</label>
                                <div class="col-sm-1">
                                    <input type="number" class="form-control" id="trdstock" name="trdstock" readonly required="true" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <div class="col-md-12">
                <div class="panel panel-success">
                    ...
                    <form role="form" class="form-horizontal" action="<?= base_url('trans/outbound/preview') ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="panel-body">
                            <div class="form-group row">
                                <label for="trno" class="col-sm-1 col-form-label text-navy text-right">Nomor.</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="trtype" name="trtype" value="OB" required="true" autocomplete="off" readonly>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="trcust" class="col-sm-1 col-form-label text-navy text-right">Pelanggan</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="trcust" name="trcust" placeholder="Nama Pelanggan" required="true" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == null) {
                        ...
                        $('#trdprice').val(data.s_price);
                        $('#trdunit').val(data.unit);
                        $('#trddesc').val(data.desc);
                        $('#trdstock').val(data.stock);
                    }
                }
            });
        });
        ...
        $('#btn_simpan').on('click', function() {
            ...
            var qty = parseInt($('#trdqty').val());
            var unit = $('#trdunit').val();
            var desc = $('#trddesc').val();
            var nilai = parseInt($('#trnilai').val());
            var stock = parseInt($('#trdstock').val());
            console.log(`Jumlah beli ${qty}, setocknya ${stock}`);
            if (qty > stock) {
